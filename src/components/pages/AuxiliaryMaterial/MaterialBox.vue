...
<template>
  <div class="sales-dashboard">
            ...
            <div class="flex flex-wrap gap-4 items-end">
                  ...
                  <div class="booking-bar-inputs">
                    <VControl class="control mr-4">
                      <DatePicker v-model="filterRange.start" dateFormat="dd-mm-yy"
                        inputClass="datepicker-input w-full px-[38px] py-3 bg-white border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-700 focus:border-amber-500 focus:ring-4 focus:ring-amber-100 transition-all duration-200 hover:border-gray-300 appearance-none cursor-pointer shadow-sm"
                ...
                <div class="relative">
                  <input type="text" v-model="itemCode" @input="handleFilterChange" placeholder="Masukkan Kode Item"
                    class="w-full px-3 py-2 pr-10 bg-white border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-700 
                           focus:border-amber-500 focus:ring-4 focus:ring-amber-100 transition-all duration-200 
              ...
              <div class="filter-group ml-auto">
                <button @click="applyFilter"
                  class="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 
    ...
    <BoxMaterialsTable :items="boxMaterials" :isFetching="isFetchingReport" :page="page" :limit="limit"
      ...
      @change-limit="handleChangeLimit" :lap="'Box'" />
  </div>
</template>
