          ...
          <div class="relative w-full">
            <div
              ...
              <div class="filter-group w-full col-span-2">
                ...
                <div class="booking-bar col-span-2">
                  <ClientOnly>
                    <VDatePicker v-model.range="filterRange" color="emerald" trim-weeks show-weeknumbers
                      :first-day-of-week="2">
            ...
            <div class="mt-3 flex justify-end">
              <button @click="applyFilter"
                class="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 
