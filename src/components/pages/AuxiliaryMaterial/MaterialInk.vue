...
<template>
  <div class="sales-dashboard">
            ...
            <div class="flex flex-wrap gap-4 items-end">
              ...
              <div class="filter-group ml-auto">
                <button @click="applyFilter"
                  class="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 
    ...
    <InkMaterialsTable :items="inkMaterials" :isFetching="isFetchingReport" :page="page" :limit="limit"
      ...
      @change-limit="handleChangeLimit" :lap="'Ink'" />
  </div>
</template>
