...
/**
 * Reject Scrap Product Data
 */
const isFetchingReport = ref(false);
const rejectScrapProducts = ref<RejectScrapProduct[]>([]);
const page = ref(1)
const limit = ref(10)
const total = ref(0)
...
const rejectScrapProductsData = async () => {
  isFetchingReport.value = true;
  await useApi.get('report/reject-scrap-product', {
    page: page.value,
    limit: limit.value,
    ...
    // Map API response to RejectScrapProduct type
    const mappedData = res.data.map((item: any): RejectScrapProduct => ({
      akhir: item.akhir || 0,
      awal: item.awal || 0,
    ...
    rejectScrapProducts.value = mappedData;
...
<template>
  <div class="sales-dashboard">
    ...
    <div
      ...
      <div class="flex flex-col lg:justify-between gap-6 w-full">
        ...
        <div class="flex items-center space-x-4">
          <div class="p-3 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl shadow-lg">
          ...
          <div>
            <h3 class="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                Laporan Pertanggung Jawaban Mutasi Barang Reject & Scrap
            </h3>
          ...
          <div class="relative w-full">
            <div
              ...
              <div class="filter-group w-full col-span-2">
                ...
                <div class="booking-bar col-span-2">
                  <ClientOnly>
                    <VDatePicker v-model.range="filterRange" color="red" trim-weeks show-weeknumbers
                      :first-day-of-week="2">
            ...
            <div class="mt-3 flex justify-end">
              <button @click="applyFilter"
                class="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 
    ...
    <RejectScrapProductReportTable :items="rejectScrapProducts" :isFetching="isFetchingReport" :page="page" :limit="limit"
