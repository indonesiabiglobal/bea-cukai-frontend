...
const props = withDefaults(defineProps<{
    items: BoxMaterials[] | null | undefined
    isFetching: boolean
...
const exportFileName = computed(() => {
    ...
    return `BoxMaterialsReport_${y}${m}${d}_${hh}${mm}.xlsx`
})
...
function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'BoxMaterials')
    ...
    <div class="w-full mb-4">
        <div class="bg-white rounded-2xl shadow p-4 md:p-6 space-y-4">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                <div>
                    <h3 class="text-base md:text-lg font-semibold text-gray-800">Laporan Bahan Box</h3>
                    <p class="text-sm text-gray-500">Laporan Persediaan Bahan Box Per Item</p>
                </div>
