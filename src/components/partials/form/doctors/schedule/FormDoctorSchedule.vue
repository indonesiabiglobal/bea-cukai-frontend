 ...
 * Imports
 */
import type { FormDoctorSchedule } from '/@src/types/Doctor/DoctorSchedule';
...
const props = defineProps<{
  modelValue: FormDoctorSchedule;
}>();

const emit = defineEmits<{
  (event: 'update:modelValue', value: FormDoctorSchedule): void;
}>();

// Reactive data
const input = ref<FormDoctorSchedule>(props.modelValue);
...
<template>
  <div class="modal-form">
    <!-- Day Code -->
    <h3 class="mb-1">Day Code</h3>
    <VField v-slot="{ id }">
      <VControl>
        <Multiselect v-model="input.day_code" :attrs="{ id }" mode="single" :options="days_options"
          placeholder="Choose Day Code" />
      </VControl>
    </VField>
    <!-- Start Time -->
    <h3 class="mb-1">Start Time</h3>
    <VField>
      <VControl>
        <DatePicker v-model="input.start_time" :showIcon="true"
          :placeholder="'Start Time'" :inputId="'start_time'" :showTime="true"
          :timeOnly="true" :showOnFocus="false" class="w-full" />
      </VControl>
    </VField>
    <!-- End Time -->
    <h3 class="mb-1">End Time</h3>
    <VField>
      <VControl>
        <DatePicker v-model="input.end_time" :showIcon="true"
          :placeholder="'End Time'" :inputId="'end_time'" :showTime="true"
          :timeOnly="true" :showOnFocus="false" class="w-full" />
      </VControl>
    </VField>
  </div>
