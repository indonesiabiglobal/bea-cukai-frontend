...
const props = withDefaults(defineProps<{
    items: MachineAndTool[] | null | undefined
    isFetching: boolean
...
const exportFileName = computed(() => {
    ...
    return `MachineAndToolReport_${y}${m}${d}_${hh}${mm}.xlsx`
})
...
function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'MachineAndTool')
    ...
    <div class="w-full mb-4">
        <div class="bg-white rounded-2xl shadow p-4 md:p-6 space-y-4">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                <div>
                    <h3 class="text-base md:text-lg font-semibold text-gray-800">Laporan Mesin dan Peralatan</h3>
                    <p class="text-sm text-gray-500">Laporan Pertanggung Jawaban Mutasi Mesin dan Peralatan</p>
                </div>

                <div class="flex items-center gap-2 w-full lg:w-auto">
                    <!-- Tombol Export -->
                    <button
                        class="px-3 py-1.5 text-sm rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow disabled:opacity-50"
