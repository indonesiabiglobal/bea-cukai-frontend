...
const linksOld = ref<SidebarItem[]>([
  {
    id: 'dashboard',
    label: 'Dashboards',
...
const moduleApp = computed(() => moduleAppSession.getModuleApp)

const links = ref<SidebarItem[]>(Array.isArray(moduleApp.value) ? moduleApp.value : [])
...
<template>
  ...
  >
    ...
    <template #extra>
      ...
      <ClientOnly>
        <VReloadPrompt app-name="BI Global Indonesia" />
      </ClientOnly>
    </template>
  </SidebarLayout>
</template>
