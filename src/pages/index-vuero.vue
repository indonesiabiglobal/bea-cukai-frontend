...
<template>
  <Layout>
        ...
        <div class="container">
          ...
          <div class="hero-mockup-wrap">
            <div class="hero-mockup">
              <img class="light-image-block" src="/images/illustrations/landing/app-1.webp" alt="">
              <img class="dark-image-block" src="/images/illustrations/landing/app-1-dark.webp" alt="">
            </div>
      ...
      <div class="container">
        ...
        <div class="cta-block">
          ...
          <div class="head-action">
            <div class="buttons">
              <a href="http://go.cssninja.io/buy-vuero"
        ...
        <div class="boxed-features is-flat pb-6">
          <div class="flex-card light-bordered hover-inset">
            ...
            <div class="flex-cell is-bordered">
              <div class="icon-holder">
                <VIcon class="smaller" icon="simple-icons:vite" />
              </div>
              <h3>Vite JS</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="akar-icons:vscode-fill" />
              </div>
            ...
            <div class="flex-cell is-bordered">
              <div class="icon-holder">
                <VIcon class="smaller" icon="file-icons:eslint" />
              </div>
              <h3>ES Lint</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="file-icons:stylelint" />
              </div>
              <h3>Stylelint</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="simple-icons:iconify" />
              </div>
              <h3>Iconify</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="simple-icons:bun" />
              </div>
              <h3>Bun</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="simple-icons:docker" />
              </div>
              <h3>Docker</h3>
              <p>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="ic:twotone-check-circle" />
              </div>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="solar:sidebar-minimalistic-bold" />
              </div>
            ...
            <div class="flex-cell">
              <div class="icon-holder">
                <VIcon class="smaller" icon="ic:round-menu-book" />
              </div>
    ...
    <MarketingSideFeatures title="Top Tier Product" subtitle="Vuero has been carefully handcrafted." :features="[
      {
        title: 'Incredible UI',
      ...
      <div class="container">
        ...
        <div class="vuero-components p-t-40 p-b-60">
          <div class="vertical-tabs-wrapper">
            <VTabs v-model:selected="activeTab" :tabs="[
              {
                label: 'Components',
                value: 'components',
              },
    ...
    <MarketingSideFeatures title="3 More Reasons To Choose Vuero"
      subtitle="If you're not convinced yet, here's some more." :features="[
        {
          title: 'Professional',
